...
old_semantic_version = re.findall(r'version="(\d+\.\d+\.[a-zA-Z0-9]+)",',
                                  version_content)
...
# Match regex for version="0.0.0a pattern
bumped_version_content = re.sub(r'(version=")\d+\.\d+\.[a-zA-Z0-9]+',
                                regex_bumped_patch_version, version_content)
