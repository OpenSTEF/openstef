...
def add_temporal_cyclic_features(data: pd.DataFrame, compute_features: list = None) -> pd.DataFrame:
    """
...
def add_time_cyclic_features(data: pd.DataFrame, frequency: str = None, period: int = 24) -> pd.DataFrame:
    """
    ...
    try:
        ...
        raise ValueError(f"Invalid frequency string: '{frequency}'. Ensure it follows pandas Timedelta conventions (e.g., '15min', '1H').")
