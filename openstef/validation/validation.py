...
def calc_completeness_dataframe(
    ...
    # for times ahead of more than 2 days
        ...
        # Correct for day-ahead-electricity-price being only expected to be available up to 24h
        if "day-ahead-electricity-price" in non_na_count.index:
            non_na_count["day-ahead-electricity-price"] += max([len(df) - 96, 0])
