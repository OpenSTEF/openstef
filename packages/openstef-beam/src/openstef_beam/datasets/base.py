...
class TimeseriesDataset:
    """Abstract base class defining the interface for time series datasets.

    Data availability is the first class citizen in this class. The datasets must implement the interface to filter the
    data as such.
    """
