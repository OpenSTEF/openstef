...
if single_target:
    ...
    best_hyperparams = optimizer.optimize_dataset(
        predictors=predictors, ground_truth=ground_truth, experiment_name=forecaster_name + "_rigorous_single"
    )

else:
    best_hyperparams = optimizer.optimize_target_provider(experiment_name=forecaster_name + "_rigorous")
