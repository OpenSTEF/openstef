...
class MissingValuesTransform(TimeSeriesTransform):
    ...
    def _remove_trailing_null_rows(self, data: TimeSeriesDataset) -> pd.DataFrame:
        ...
        features_to_check = [
            f for f in self.config.no_fill_future_values_features
            if f in data.data.columns
        ]
    ...
    def fit(self, data: TimeSeriesDataset) -> None:
        ...
        Returns:
            None: This method modifies the transformer in-place by fitting the internal
                imputer.
        """
