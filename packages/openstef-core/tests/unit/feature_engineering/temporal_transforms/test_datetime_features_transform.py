...
"""Unit tests for the DatetimeFeaturesTransform."""
...
from openstef_core.feature_engineering.temporal_transforms.datetime_features_transform import DatetimeFeaturesTransform
...
def test_datetime_features_onehot_encoding():
    ...
    transform = DatetimeFeaturesTransform(onehot_encode=True)
    result = transform.transform(input_data)
