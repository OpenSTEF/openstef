...
def test_daylight_features_basic():
    ...
    transform = DaylightFeaturesTransform(coordinate=Coordinate(latitude=52.0, longitude=5.0))
...
def test_daylight_features_different_coordinates():
    ...
    amsterdam_transform = DaylightFeaturesTransform(coordinate=Coordinate(latitude=52.0, longitude=5.0))
    amsterdam_result = amsterdam_transform.transform(input_data)

    # Cape Town (southern hemisphere, winter)
    capetown_transform = DaylightFeaturesTransform(coordinate=Coordinate(latitude=-33.9, longitude=18.4))
