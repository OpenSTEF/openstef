...
from openstef_core.feature_engineering.temporal_transforms.holiday_features_transform import HolidayFeaturesTransform
...
@patch("openstef_core.feature_engineering.temporal_transforms.holiday_features_transform.holidays.country_holidays")
