...
from openstef_models.estimators.randomforestgbm import LGBMQuantileRegressor
...
class RFLHyperParams(HyperParams):
...
class RFLForecasterConfig(ForecasterConfig):
    ...
    >>> config = RFLForecasterConfig(
    ...     quantiles=[Quantile(0.1), Quantile(0.5), Quantile(0.9)],
    ...     horizons=[LeadTime(timedelta(hours=1))],
    ...     hyperparams=RFLHyperParams(n_estimators=100, max_depth=6))
    """  # noqa: D205

    hyperparams: RFLHyperParams = RFLHyperParams()
...
class RFLForecaster(Forecaster, ExplainableForecaster):
    ...
    _config: RFLForecasterConfig
    _rfl_model: LGBMQuantileRegressor

    def __init__(self, config: RFLForecasterConfig) -> None:
        ...
        self._rfl_model = LGBMQuantileRegressor(
    ...
    @property
    @override
    def hyperparams(self) -> RFLHyperParams:
        return self._config.hyperparams

    @property
    @override
    def is_fitted(self) -> bool:
        return self._rfl_model.__sklearn_is_fitted__()
    ...
    def predict(self, data: ForecastInputDataset) -> ForecastDataset:
        ...
        prediction: npt.NDArray[np.floating] = self._rfl_model.predict(X=input_data)
...
__all__ = ["RFLForecaster", "RFLForecasterConfig", "RFLHyperParams"]
