...
from openstef_models.feature_engineering.temporal_transforms import HolidayFeaturesTransform
...
@patch("openstef_models.feature_engineering.temporal_transforms.holiday_features_transform.holidays.country_holidays")
