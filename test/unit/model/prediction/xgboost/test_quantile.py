...
class TestQuantileXGBPredictionModel(BaseTestCase):
    ...
    def test_add_stdev_to_forecast(self):
        quantile_forecast = pd.DataFrame({
            'forecast': [5, 6, 7],
            'quantile_P01': [3.8368260629795796, 4.604191275575496, 5.371556488171412],
            'quantile_P10': [4.3592242172277, 5.2310690606732395, 6.10291390411878],
            'quantile_P25': [4.662755124901959, 5.595306149882351, 6.527857174862743],
            'quantile_P50': [5.0, 6.0, 7.0],
            'quantile_P75': [5.337244875098041, 6.404693850117649, 7.472142825137257],
            'quantile_P90': [5.6407757827723, 6.7689309393267605, 7.89708609588122],
            'quantile_P99': [6.163173937020421, 7.395808724424504, 8.62844351182859]
        })
